...
public class ListViewAdapter_Nguoibenh extends ArrayAdapter<getset_NguoiBenh> {
	LayoutInflater inflater;
	Activity context = null;
	int itemlayout;
	List<getset_NguoiBenh> worldpopulationlist = null;
	ArrayList<getset_NguoiBenh> arrNews = null;

	public ListViewAdapter_Nguoibenh(Activity context, int motSanPham, ArrayList<getset_NguoiBenh> objects) {
		super(context, -1, objects);
		this.worldpopulationlist = worldpopulationlist;
		inflater = LayoutInflater.from(context);
		this.arrNews = new ArrayList<getset_NguoiBenh>();
	...
	@Override
	public getset_NguoiBenh getItem(int position) {
	...
	public void filter(String charText) {
		...
		{
			for (getset_NguoiBenh wp : arrNews) 
			{
