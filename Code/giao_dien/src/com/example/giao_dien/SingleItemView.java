...
public class SingleItemView extends Activity implements NavigationDrawerFragment.NavigationDrawerCallbacks{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (b != null) {
			getset st = (getset) b.getSerializable("ct_st");
	...
	public void onSectionAttached(int number) {
		...
		case 1:
			...
			Intent i1 = new Intent(SingleItemView.this, Getting_start.class);
			startActivity(i1);
			break;
		case 2:
			mTitle = getString(R.string.title_section2);
			Intent i2 = new Intent(SingleItemView.this, NoteEdit.class);
			startActivity(i2);
			break;
		case 3:
			mTitle = getString(R.string.title_section3);
			Intent i3 = new Intent(SingleItemView.this, Huongdannauan.class);
			startActivity(i3);
			break;
		case 4:
			mTitle = getString(R.string.title_section4);
			Intent i4 = new Intent(SingleItemView.this, Nguoi_beo.class);
			startActivity(i4);
			break;
		case 5:
			mTitle = getString(R.string.title_section5);
			Intent i5 = new Intent(SingleItemView.this, Nguoi_Gay.class);
			startActivity(i5);
			break;
		case 6:
			mTitle = getString(R.string.title_section6);
			Intent i6 = new Intent(SingleItemView.this, Nguoi_benh.class);
			startActivity(i6);
			break;
		case 7:
			mTitle = getString(R.string.title_section7);
			Intent i7 = new Intent(SingleItemView.this, Mainbmi.class);
			startActivity(i7);
			break;
		case 8:
	...
	public static class PlaceholderFragment extends Fragment {
		...
		public void onAttach(Activity activity) {
			...
			((SingleItemView) activity).onSectionAttached(getArguments().getInt(ARG_SECTION_NUMBER));
		}
	}
