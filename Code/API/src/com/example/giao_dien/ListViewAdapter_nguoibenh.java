...
public class ListViewAdapter_nguoibenh extends ArrayAdapter<WorldPopulation_nguoibenh> {
	Activity context = null;
	int itemlayout;
	ArrayList<WorldPopulation_nguoibenh> arrNews = null;

	public ListViewAdapter_nguoibenh(Activity context, int motSanPham, ArrayList<WorldPopulation_nguoibenh> objects) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		WorldPopulation_nguoibenh st = getItem(position);
		if (st != null) {
