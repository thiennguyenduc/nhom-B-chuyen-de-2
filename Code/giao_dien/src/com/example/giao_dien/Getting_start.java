...
public class Getting_start extends Activity implements NavigationDrawerFragment.NavigationDrawerCallbacks {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btn_hdan.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(Getting_start.this, Huongdannauan.class);
	...
	public void onSectionAttached(int number) {
		...
		case 1:
			...
			Intent i1 = new Intent(Getting_start.this, Getting_start.class);
			startActivity(i1);
			break;
		case 2:
		...
		case 3:
			...
			Intent i3 = new Intent(Getting_start.this, Huongdannauan.class);
			startActivity(i3);
			break;
		case 4:
