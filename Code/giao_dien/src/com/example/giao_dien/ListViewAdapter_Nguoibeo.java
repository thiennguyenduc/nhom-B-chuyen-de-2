...
public class ListViewAdapter_Nguoibeo extends ArrayAdapter<getset_NguoiBeo> {
	LayoutInflater inflater;
	Activity context = null;
	int itemlayout;
	List<getset_NguoiBeo> worldpopulationlist = null;
	ArrayList<getset_NguoiBeo> arrNews = null;

	public ListViewAdapter_Nguoibeo(Activity context, int motSanPham, ArrayList<getset_NguoiBeo> dsST) {
		super(context, -1, dsST);
		this.worldpopulationlist = worldpopulationlist;
		inflater = LayoutInflater.from(context);
		this.arrNews = new ArrayList<getset_NguoiBeo>();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			convertView = inflater.inflate(R.layout.listview_item_nguoibeo, null);
		}
		...
		getset_NguoiBeo st = getItem(position);
		if (st != null) {
	...
	@Override
	public getset_NguoiBeo getItem(int position) {
	...
	public void filter(String charText) {
		...
		{
			for (getset_NguoiBeo wp : arrNews) 
			{
