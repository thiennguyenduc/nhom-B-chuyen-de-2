...
public class SingleItemView_home extends Activity implements NavigationDrawerFragment.NavigationDrawerCallbacks{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.singleitemview_home);
		...
		if(b != null) {
			WorldPopulation_home st = (WorldPopulation_home) b.getSerializable("ct_st");
	...
	public void onSectionAttached(int number) {
		...
		case 2:
			...
			Intent i2 = new Intent(SingleItemView_home.this, NoteEdit.class);
			startActivity(i2);
			break;
		case 3:
			mTitle = getString(R.string.title_section3);
			Intent i3 = new Intent(SingleItemView_home.this, Home.class);
			startActivity(i3);
			break;
		case 4:
			mTitle = getString(R.string.title_section4);
			Intent i4 = new Intent(SingleItemView_home.this, Nguoi_Beo.class);
			startActivity(i4);
			break;
		case 5:
			mTitle = getString(R.string.title_section5);
			Intent i5 = new Intent(SingleItemView_home.this, Nguoi_Gay.class);
			startActivity(i5);
			break;
		case 6:
			mTitle = getString(R.string.title_section6);
			Intent i6 = new Intent(SingleItemView_home.this, Nguoi_Benh.class);
			startActivity(i6);
			break;
		case 7:
			mTitle = getString(R.string.title_section7);
			Intent i7 = new Intent(SingleItemView_home.this, BmiEdit.class);
			startActivity(i7);
			break;
		case 8:
			mTitle = getString(R.string.title_section8);
			Intent i8 = new Intent(SingleItemView_home.this, nguyen_lieu.class);
			startActivity(i8);
			break;
		}
	}
	...
	public static class PlaceholderFragment extends Fragment {
		...
		public void onAttach(Activity activity) {
			...
			((SingleItemView_home) activity).onSectionAttached(getArguments().getInt(ARG_SECTION_NUMBER));
		}
	}
}
