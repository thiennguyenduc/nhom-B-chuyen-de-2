...
public class Getting_start extends Activity implements NavigationDrawerFragment.NavigationDrawerCallbacks {
	...
	private Button btn_home1, btn_hdan1, btn_chedobeo1, btn_chedogay1, btn_ghichu1;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btn_hdan1 = (Button) findViewById(R.id.btn_hdan);
		addListenerOnButton();
		btn_chedobeo1 = (Button) findViewById(R.id.btn_chedobeo);
		addListenerOnButton();
		btn_chedogay1 = (Button) findViewById(R.id.btn_chedogay);
		addListenerOnButton();
		btn_ghichu1 = (Button) findViewById(R.id.btn_ghichu);
		addListenerOnButton();
		btn_home1 = (Button) findViewById(R.id.btn_home);
        addListenerOnButton();
	...
	public void addListenerOnButton() {
		...
		btn_hdan.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View arg0) {
				btn_hdan.setFocusableInTouchMode(false);
				btn_hdan.setFocusable(false);
				Intent intent = new Intent(Getting_start.this, Home.class);
				startActivity(intent);
			}
		});
	...
	btn_chedobeo.setOnClickListener(new View.OnClickListener() {
		...
		@Override
		public void onClick(View v) {
			btn_chedobeo.setFocusableInTouchMode(false);
			btn_chedobeo.setFocusable(false);
			Intent intent = new Intent(Getting_start.this, Nguoi_Beo.class);
			startActivity(intent);
		}
	});
	...
	btn_chedogay.setOnClickListener(new View.OnClickListener() {
		...
		@Override
		public void onClick(View v) {
			btn_chedogay.setFocusableInTouchMode(false);
			btn_chedogay.setFocusable(false);
			Intent intent = new Intent(Getting_start.this, Nguoi_Gay.class);
			startActivity(intent);
		}
	});
	...
	btn_ghichu.setOnClickListener(new View.OnClickListener() {
		...
		@Override
		public void onClick(View v) {
			btn_ghichu.setFocusableInTouchMode(false);
			btn_ghichu.setFocusable(false);
			Intent intent = new Intent(Getting_start.this, NoteEdit.class);
			startActivity(intent);
		}
	});
	...
	public void onSectionAttached(int number) {
		...
		case 7:
			...
			Intent i7 = new Intent(Getting_start.this, BmiEdit.class);
			startActivity(i7);
			break;
		case 8:
