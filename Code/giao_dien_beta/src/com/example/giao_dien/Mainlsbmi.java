...
public class Mainlsbmi extends Activity implements NavigationDrawerFragment.NavigationDrawerCallbacks{
	...
	public void onSectionAttached(int number) {
		...
		case 3:
			...
			Intent i3 = new Intent(Mainlsbmi.this, Home_giaodien.class);
			startActivity(i3);
			break;
		case 4:
			mTitle = getString(R.string.title_section4);
			Intent i4 = new Intent(Mainlsbmi.this, Nguoi_Beo_giaodien.class);
			startActivity(i4);
			break;
		case 5:
		...
		case 8:
			...
			Intent i8 = new Intent(Mainlsbmi.this, nguyen_lieu.class);
			startActivity(i8);
			break;
		}
	}
