...
public class Getting_start extends Activity implements NavigationDrawerFragment.NavigationDrawerCallbacks {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btn_hdan.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(Getting_start.this, Home_giaodien.class);
		...
		btn_chedobeo.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(Getting_start.this, Nguoi_Beo_giaodien.class);
				startActivity(intent);
			}
		});
	...
	public void onSectionAttached(int number) {
		...
		case 3:
			...
			Intent i3 = new Intent(Getting_start.this, Home_giaodien.class);
			startActivity(i3);
			break;
		case 4:
			mTitle = getString(R.string.title_section4);
			Intent i4 = new Intent(Getting_start.this, Nguoi_Beo_giaodien.class);
			startActivity(i4);
			break;
		case 5:
