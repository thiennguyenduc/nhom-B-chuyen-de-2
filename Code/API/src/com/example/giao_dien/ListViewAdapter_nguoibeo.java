...
public class ListViewAdapter_nguoibeo extends ArrayAdapter<WorldPopulation_nguoibeo> {
	Activity context = null;
	int itemlayout;
	ArrayList<WorldPopulation_nguoibeo> arrNews = null;

	public ListViewAdapter_nguoibeo(Activity context, int motSanPham, ArrayList<WorldPopulation_nguoibeo> objects) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		WorldPopulation_nguoibeo st = getItem(position);
		if (st != null) {
