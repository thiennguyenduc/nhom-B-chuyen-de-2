...
public class ListViewAdapter_Huongdannauan extends ArrayAdapter<getset_Huongdannauan> {
	LayoutInflater inflater;
	Activity context = null;
	int itemlayout;
	List<getset_Huongdannauan> worldpopulationlist = null;
	ArrayList<getset_Huongdannauan> arrNews = null;

	public ListViewAdapter_Huongdannauan(Activity context, int motSanPham, ArrayList<getset_Huongdannauan> objects) {
		super(context, -1, objects);
		this.context = context;
		this.worldpopulationlist = worldpopulationlist;
		inflater = LayoutInflater.from(context);
		this.arrNews = new ArrayList<getset_Huongdannauan>();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			convertView = inflater.inflate(R.layout.listview_item_huongdannauan, null);
		}
		...
		getset_Huongdannauan st = getItem(position);
		if (st != null) {
	...
	@Override
	public getset_Huongdannauan getItem(int position) {
	...
	public void filter(String charText) {
		...
		{
			for (getset_Huongdannauan wp : arrNews) 
			{
