...
public class ListViewAdapter_home extends ArrayAdapter<WorldPopulation_home> {
	Activity context = null;
	int itemlayout;
	ArrayList<WorldPopulation_home> arrNews = null;

	public ListViewAdapter_home(Activity context, int motSanPham, ArrayList<WorldPopulation_home> objects) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			convertView = inflater.inflate(R.layout.listview_item_home, null);
		}
		...
		WorldPopulation_home st = getItem(position);
		if (st != null) {
