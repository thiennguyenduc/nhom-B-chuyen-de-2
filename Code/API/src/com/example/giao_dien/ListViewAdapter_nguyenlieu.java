...
public class ListViewAdapter_nguyenlieu extends ArrayAdapter<DiaChiAll> {
	Activity context = null;
	int itemlayout;
	ArrayList<DiaChiAll> arrNews = null;

	public ListViewAdapter_nguyenlieu(Activity context, int motSanPham, ArrayList<DiaChiAll> objects) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			convertView = inflater.inflate(R.layout.listview_item_nguyenlieusach, null);
		}
