...
public class ListViewAdapter extends ArrayAdapter<getset> {
	LayoutInflater inflater;
	Activity context = null;
	int itemlayout;
	List<getset> worldpopulationlist = null;
	ArrayList<getset> arrNews = null;

	public ListViewAdapter(Activity context, int motSanPham, ArrayList<getset> objects) {
		super(context, -1, objects);
		this.context = context;
		this.worldpopulationlist = worldpopulationlist;
		inflater = LayoutInflater.from(context);
		this.arrNews = new ArrayList<getset>();
